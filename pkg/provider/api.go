...
func (c *MCPSlackClient) UpdateMessageContext(ctx context.Context, channelID string, timestamp string, options ...slack.MsgOption) (string, string, string, error) {
	return c.slackClient.UpdateMessageContext(ctx, channelID, timestamp, options...)
}

func (c *MCPSlackClient) DeleteMessageContext(ctx context.Context, channelID string, timestamp string) (string, string, error) {
